  ...
  <div>
    ...
    <v-row justify="center" class="mt-3 mb-4">
      <v-text-field
        ...
        class="shrink mx-4"
      />
      <v-btn :color="type === warning ? 'purple' : 'error'" rounded @click="searchData()">
      Search
      </v-btn><br><br>
    </v-row>
...
.theme--dark.v-application {
  background-image: url("https://cdn.discordapp.com/attachments/760843901199843338/760845398247604244/one-piece-profile-fb.jpg");
